...
## 项目经历
>### 测试环境治理
>**项目描述**: 本项目主要为解决开发人员在开发和测试过程中能快速分配对应的测试环境，并通过强制修改系统配置，解决各环境之间系统的依赖 
>
>**工作成果**: 方案调研，资源整合，核心功能设计开发，插件推动
>
>**项目简介**:
> 整合现有公司内部的容器平台(北极星)，通过namespace控制环境隔离，dtools自主发布，bit(测试产物收集)，testdata(测试数据隔离)
> > - **系统设计**: 以链表行为控制服务的发布、配置覆盖、测试、销毁
> > - **技术栈**: golang , trpc-go（rpc服务） 
